...
const Footer = (props: Props) => {
  ...
  return (
    <footer
      ...
      className="px-4"
    >
      <div className="relative max-w-7xl mx-auto py-10 border-t border-slate-300/20 flex flex-col-reverse sm:flex-row justify-between items-center text-center">
        {/* Copyright */}
        <p>
